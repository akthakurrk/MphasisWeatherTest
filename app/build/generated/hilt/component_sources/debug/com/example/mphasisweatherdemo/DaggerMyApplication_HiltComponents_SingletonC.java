...
import com.example.mphasisweatherdemo.networks.RetroClient_GetInstanceFactory;
import com.example.mphasisweatherdemo.networks.RetroClient_ProvideOkhttpClientFactory;
import com.example.mphasisweatherdemo.networks.RetroClient_ProviderServiceFactory;
...
import com.example.mphasisweatherdemo.viewmodels.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    public Builder retroClient(RetroClient retroClient) {
      this.retroClient = Preconditions.checkNotNull(retroClient);
      return this;
    }
    ...
    public MyApplication_HiltComponents.SingletonC build() {
      ...
      return new SingletonCImpl(applicationContextModule, retroClient);
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private MainRepository mainRepository() {
      return new MainRepository(singletonCImpl.retroServices());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.mphasisweatherdemo.viewmodels.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.mphasisweatherdemo.viewmodels.MainViewModel 
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private SingletonCImpl(ApplicationContextModule applicationContextModuleParam,
        RetroClient retroClientParam) {
      this.retroClient = retroClientParam;
      this.applicationContextModule = applicationContextModuleParam;

    }

    private OkHttpClient okHttpClient() {
      return RetroClient_ProvideOkhttpClientFactory.provideOkhttpClient(retroClient, ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
    }

    private Retrofit retrofit() {
      return RetroClient_GetInstanceFactory.getInstance(retroClient, okHttpClient());
    }

    private RetroServices retroServices() {
      return RetroClient_ProviderServiceFactory.ProviderService(retroClient, retrofit());
    }
